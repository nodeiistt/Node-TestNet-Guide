...
```
sudo -i
wget -O $HOME/inery.sh https://raw.githubusercontent.com/SaujanaOK/Node-TestNet-Guide/main/Inery%20Node%20Testnet/Inery%20Task%201/Inery.sh && chmod 777 $HOME/inery.sh && bash $HOME/inery.sh
```
